    ...
    function quickview_popup() {
        ...
        if (window_size > 992) {
            $(document).on('click', '.quick-wiew-button', function () {
                $.magnificPopup.open({
                    items: {
                        src: '<div class="kt-popup-quickview "><div class="details-thumb"><div class="slider-product slider-for"><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div></div><div class="slider-product-button slider-nav nav-center"><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div><div class="details-item"><img src="assets/images/kindpng_239356.png" alt="img"></div></div></div><div class="details-infor"><h1 class="product-title">Glorious Eau</h1><div class="stars-rating"><div class="star-rating"><span class="star-5"></span></div><div class="count-star">(7)</div></div><div class="availability">توافر:<a href="#">متوفر</a></div><div class="price"><span>AED 45</span></div><div class="product-details-description"><ul><li>درجة حرارة التصنيع</li><li>مستورد</li><li>Art.No. 06-7680</li></ul><div class="group-button"><div class="yith-wcwl-add-to-wishlist"></div><div class="size-chart-wrapp"><div class="btn-size-chart"><a id="size_chart" href="assets/images/sizeChart.jpg" class="fancybox"  target="_blank">عرض مخطط الحجم</a></div></div><div class="quantity-add-to-cart"><div class="quantity"><div class="control"><a class="btn-number qtyminus quantity-minus" href="#">-</a><input type="text" data-step="1" data-min="0" value="1" title="Qty" class="input-qty qty" size="4"><a href="#" class="btn-number qtyplus quantity-plus">+</a></div></div><button class="single_add_to_cart_button button">أضف إلى السلة</button></div></div></div></div>',
                        type: 'inline'
                    }
                });
