...
{{--                        </div>--}}
                    ...
                    <div class="button-control">
                        ...
                        <a href="#" class="button btn-pay-now" data-toggle="modal" data-target="#exampleModal">ادفع الآن</a>
                        @include('website.chrckout.index')
                    </div>
                </div>
                <div class="end-checkout-wrapp">
                    <div class="end-checkout checkout-form">
                        ...
                        <a href="{{route('website')}}" class="button btn-return">العودة إلى المتجر</a>
                    </div>
                </div>
            </div>
        </div>
